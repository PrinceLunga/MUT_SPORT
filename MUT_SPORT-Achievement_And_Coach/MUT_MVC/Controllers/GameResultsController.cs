...
namespace MUT_MVC.Controllers
{
    public class GameResultController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> GetAllGameResult()
        {
        ...
        public ViewResult AddGameResult() => View();

        [HttpPost]
        public async Task<IActionResult> AddGameResult(GameResultModel gameResult)
        {
            using (var httpClient = new HttpClient())
            {
            ...
            return RedirectToAction(nameof(GetAllGameResult));
        }
        [HttpPost]
        public async Task<IActionResult> UpdateGameResults(GameResultModel gameResultModel)
        {
            using (var httpClient = new HttpClient())
            {
                ...
                return RedirectToAction("GetGameResult");
            }
        }
    }
}